...
public class SDLActivity extends Activity implements View.OnSystemUiVisibilityChangeListener {
    private static final String TAG = "jni/SDL";
    ...
    public void setOrientationBis(int w, int h, boolean resizable, String hint) 
    {
        ...
        Log.v("jni/SDL", "setOrientation() orientation=" + orientation + " width=" + w +" height="+ h +" resizable=" + resizable + " hint=" + hint);
        if (orientation != -1) {
    ...
    public static boolean getManifestEnvironmentVariables() {
        try {
           ...
           Log.v("jni/SDL", "exception " + e.toString());
        }
        return false;
    }
...
class SDLMain implements Runnable {
    ...
    public void run() {
        ...
        Log.v("jni/SDL", "Running main function " + function + " from library " + library);
        SDLActivity.nativeRunMain(library, function, arguments);

        Log.v("jni/SDL", "Finished main function");
...
class SDLSurface extends SurfaceView implements SurfaceHolder.Callback,
    ...
    public void surfaceDestroyed(SurfaceHolder holder) {
        Log.v("jni/SDL", "surfaceDestroyed()");
    ...
    public void surfaceChanged(SurfaceHolder holder,
        ...
        case PixelFormat.A_8:
            Log.v("jni/SDL", "pixel format A_8");
            break;
        case PixelFormat.LA_88:
            Log.v("jni/SDL", "pixel format LA_88");
            break;
        case PixelFormat.L_8:
            Log.v("jni/SDL", "pixel format L_8");
            break;
        case PixelFormat.RGBA_4444:
            Log.v("jni/SDL", "pixel format RGBA_4444");
            sdlFormat = 0x15421002; // SDL_PIXELFORMAT_RGBA4444
            break;
        case PixelFormat.RGBA_5551:
            Log.v("jni/SDL", "pixel format RGBA_5551");
            sdlFormat = 0x15441002; // SDL_PIXELFORMAT_RGBA5551
            break;
        case PixelFormat.RGBA_8888:
            Log.v("jni/SDL", "pixel format RGBA_8888");
            sdlFormat = 0x16462004; // SDL_PIXELFORMAT_RGBA8888
            break;
        case PixelFormat.RGBX_8888:
            Log.v("jni/SDL", "pixel format RGBX_8888");
            sdlFormat = 0x16261804; // SDL_PIXELFORMAT_RGBX8888
            break;
        case PixelFormat.RGB_332:
            Log.v("jni/SDL", "pixel format RGB_332");
            sdlFormat = 0x14110801; // SDL_PIXELFORMAT_RGB332
            break;
        case PixelFormat.RGB_565:
            Log.v("jni/SDL", "pixel format RGB_565");
            sdlFormat = 0x15151002; // SDL_PIXELFORMAT_RGB565
            break;
        case PixelFormat.RGB_888:
            Log.v("jni/SDL", "pixel format RGB_888");
            // Not sure this is right, maybe SDL_PIXELFORMAT_RGB24 instead?
            sdlFormat = 0x16161804; // SDL_PIXELFORMAT_RGB888
            break;
        default:
            Log.v("jni/SDL", "pixel format unknown " + format);
            break;
        }
        ...
        Log.v("jni/SDL", "Window size: " + width + "x" + height);
        Log.v("jni/SDL", "Device size: " + nDeviceWidth + "x" + nDeviceHeight);
        ...
        if (skip) {
           ...
           if (max / min < 1.20) {
              Log.v("jni/SDL", "Don't skip on such aspect-ratio. Could be a square resolution.");
              skip = false;
           }
        }

        if (skip) {
           Log.v("jni/SDL", "Skip .. Surface is not ready.");
           SDLActivity.mIsSurfaceReady = false;
           return;
        }
